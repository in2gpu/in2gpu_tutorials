...
CubeTextureAdvanced::CubeTextureAdvanced()
{
}
...
void CubeTextureAdvanced::Create()
{
	GLuint vao;
	GLuint vbo;
	GLuint ibo;
...
void CubeTextureAdvanced::Update()
{
	rotation = 0.01f * rotation_speed + rotation;
	rotation_sin = glm::vec3(rotation.x * PI / 180, rotation.y * PI / 180, rotation.z * PI / 180);
}

void CubeTextureAdvanced::Draw(const glm::mat4& projection_matrix, const glm::mat4& view_matrix)
{
